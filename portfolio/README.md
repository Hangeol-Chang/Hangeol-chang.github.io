...
- 위의 사진을 보면, 나비와 화살이 날라가는 것을 볼 수 있다. 게임을 진행하는 데에 있어서, 이같은 오브젝트의 생성, 삭제를 반복하는 것은 **외부 메모리 단편화**의 원인이 된다. 이를 해결하기 위해 
...
- 실제 메이플스토리와 유사한 경험을 제공하기 위해서 글자에 그라디언트 효과를 입히고,<br>데미지가 몬스터의 상단에서 나타난 후 천천히 위로 올라가며 사라지도록 하였다. 
